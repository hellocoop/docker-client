...
# NPM package name
NPM_PACKAGE_NAME="@hellocoop/client"    
...
PUBLISHED_VERSION=$(curl -s "https://hub.docker.com/v2/repositories/hellocoop/client/tags/?page_size=1" | jq -r '.results[0].name')
...
#
# uncomment below if we decide to publish to npm
#
